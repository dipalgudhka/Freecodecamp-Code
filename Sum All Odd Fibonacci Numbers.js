...
of the two previous numbers. The first six numbers of the Fibonacci sequence are 1, 1, 2, 3, 5 and 8.For example,
sumFibs(10) should return 10 because all odd Fibonacci numbers less than 10 are 1, 1, 3, and 5.
*/

function sumFibs(num) {
  
  var arr = [1], number1 = 0, number2 = 1;
  ...
  var newArr = arr.filter(function (number) {
    return number <= num && number%2 != 0;
  });
  
  var total = newArr.reduce(function(sum, value) {
    return sum + value;
  }, 0);
